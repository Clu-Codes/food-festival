...
$(document).ready(function() {
  ...
  // Previously createEl function

  // previously had schedule page checker

// previously had events page checker

// previously had dateConverter();

  // Previously had tickets checker
